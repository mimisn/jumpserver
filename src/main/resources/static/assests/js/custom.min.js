$(document).ready(
	...
	function template_functions(){
		...
		$(".raty").raty({score:4});$("#file_upload").uploadify({swf:"misc/uploadify.swf",uploader:"misc/uploadify.php"});
		...
		$(".progressAnimate").progressbar(
			{
				value:1,
				create:function(){
					$(".progressAnimate .ui-progressbar-value").animate(
						{width:"100%"},
						{
							duration:10000,
							step:function(b){
		...
		$(".progressUploadAnimate").progressbar(
			{
				value:1,
				create:function(){
					$(".progressUploadAnimate .ui-progressbar-value").animate(
						{width:"100%"},
						{
							duration:20000,
							easing:"linear",
